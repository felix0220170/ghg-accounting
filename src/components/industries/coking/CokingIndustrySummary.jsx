...
const CokingIndustrySummary = ({ emissionData, industry, onDataChange }) => {
  // 确保data不为undefined
  ...
  const calculateBaseTotal = () => {
    return (
      ...
      calculateEmission('processEmission') - // 使用processEmission而不是cokeProductionEmission
  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧CO2排放 + 工业生产过程排放 - <span style={{ color: '#1890ff', fontWeight: 'bold', backgroundColor: '#e6f7ff', padding: '2px 4px', borderRadius: '3px' }}>企业CO2回收利用量</span></p>
...
export default CokingIndustrySummary;