...
function CokingCarbonInventory() {
  // 焦化工行业碳排查材料清单数据
  const inventoryItems = [
    ...
    { key: '7', name: '入厂原燃料（煤等）消耗量原始记录' },
    { key: '8', name: '原燃料入炉记录和台账' },
    { key: '9', name: '月度原燃料盘点表' },
    { key: '10', name: '煤、柴油等结算发票' },
    { key: '11', name: '柴油/汽油消耗原始记录' },
    { key: '12', name: '《能源购进、消费与库存表》' },
    { key: '13', name: '焦炉生产记录' },
    { key: '14', name: '备煤工序生产记录' },
    { key: '15', name: '煤气净化工序生产记录' },
    { key: '16', name: '化学产品回收工序生产记录' },
    { key: '17', name: '入厂煤质分析报告' },
    { key: '18', name: '焦炭工业分析报告' },
    { key: '19', name: '焦炭元素分析报告' },
    { key: '20', name: '煤焦油成分分析报告' },
    { key: '21', name: '粗苯成分分析报告' },
    { key: '22', name: '皮带秤校验记录' },
    { key: '23', name: '电子汽车衡检定证书' },
    { key: '24', name: '电子天平检定证书' },
    { key: '25', name: '碳氢分析仪维护记录' },
    { key: '26', name: '下网电量抄表记录' },
    { key: '27', name: '下网电量结算单' },
    { key: '28', name: '下网电力结算发票' },
    { key: '29', name: '下网电量电能表检定证书' },
    { key: '30', name: '余热余能发电记录' },
    { key: '31', name: '煤气发生量记录' },
    { key: '32', name: '产品产量台账（焦炭、焦炉煤气、煤焦油等）' },
    { key: '33', name: '外购电力排放因子证明文件' },
    { key: '34', name: '主要生产设备台账' }
  ];
  ...
  return (
    <Card title="碳排查材料清单" style={{ marginBottom: '20px' }}>
      ...
      <Paragraph>
        本模块用于上传焦化工行业碳排查所需的材料清单文件。请按照要求上传相关证明材料和记录文档。
...
export default CokingCarbonInventory;