...
function SteelCarbonInventory() {
  ...
  const inventoryItems = [
    ...
    { key: '7', name: '入厂原燃料（煤、焦炭、铁矿石等）消耗量原始记录' },
    { key: '8', name: '原燃料入炉记录和台账' },
    { key: '9', name: '月度原燃料盘点表' },
    { key: '10', name: '煤、焦炭、柴油等结算发票' },
    { key: '11', name: '柴油/汽油消耗原始记录' },
    { key: '12', name: '《能源购进、消费与库存表》' },
    { key: '13', name: '高炉炼铁生产记录' },
    { key: '14', name: '转炉/电炉炼钢生产记录' },
    { key: '15', name: '轧钢生产记录' },
    { key: '16', name: '焦炉生产记录' },
    { key: '17', name: '烧结/球团生产记录' },
    { key: '18', name: '入厂煤质分析报告' },
    { key: '19', name: '焦炭工业分析报告' },
    { key: '20', name: '焦炭元素分析报告' },
    { key: '21', name: '铁矿石成分分析报告' },
    { key: '22', name: '石灰石/白云石成分分析报告' },
    { key: '23', name: '皮带秤校验记录' },
    ...
    { key: '31', name: '余热余能发电记录' },
    { key: '32', name: '煤气发生量记录' },
    { key: '33', name: '产品产量台账（粗钢、钢材等）' },
    { key: '34', name: '外购电力排放因子证明文件' },
    { key: '35', name: '主要生产设备台账' }
  ];
  ...
  return (
    <Card title="碳排查材料清单" style={{ marginBottom: '20px' }}>
      ...
      <Paragraph>
        本模块用于上传钢铁生产行业碳排查所需的材料清单文件。请按照要求上传相关证明材料和记录文档。
...
export default SteelCarbonInventory;