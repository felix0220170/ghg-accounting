...
function PetroleumCarbonInventory() {
  // 石油化工企业碳排查材料清单数据
  const inventoryItems = [
    ...
    { key: '3', name: '组织机构图' },
    { key: '4', name: '厂区平面图' },
    { key: '5', name: '石油化工主要生产工艺流程图' },
    { key: '6', name: '备案的数据质量控制计划' },
    { key: '7', name: '化石燃料（煤、油、气等）消耗量原始记录' },
    { key: '8', name: '火炬燃烧系统运行记录' },
    { key: '9', name: '火炬气流量监测记录' },
    { key: '10', name: '火炬气成分分析报告' },
    { key: '11', name: '催化裂化装置运行记录' },
    { key: '12', name: '催化重整装置运行记录' },
    { key: '13', name: '乙烯裂解装置运行记录' },
    { key: '14', name: '制氢装置运行记录' },
    { key: '15', name: '焦化装置运行记录' },
    { key: '16', name: '石油焦煅烧装置运行记录' },
    { key: '17', name: '乙二醇/环氧乙烷装置运行记录' },
    { key: '18', name: '燃料油/汽油/柴油消耗原始记录' },
    { key: '19', name: '《能源购进、消费与库存表》' },
    { key: '20', name: 'CO2回收利用系统运行记录' },
    { key: '21', name: 'CH4回收利用系统运行记录' },
    { key: '22', name: '回收气体流量监测记录' },
    { key: '23', name: '回收气体成分分析报告' },
    { key: '24', name: '化石燃料元素分析报告' },
    { key: '25', name: '废气排放监测记录' },
    { key: '26', name: '外购原材料采购合同和发票' },
    { key: '27', name: '流量计校验记录' },
    ...
    { key: '34', name: '产品产量台账（成品油、化工产品等）' },
    { key: '35', name: '外购电力排放因子证明文件' },
    { key: '36', name: '主要生产设备台账' },
    { key: '37', name: '碳氧化率相关证明文件' },
    { key: '38', name: '催化剂烧焦排放监测记录' }
  ];
  ...
  return (
    <Card title="碳排查材料清单" style={{ marginBottom: '20px' }}>
      ...
      <Paragraph>
        本模块用于上传石油化工企业碳排查所需的材料清单文件。请按照要求上传相关证明材料和记录文档。
        所有材料为碳排查工作的必要支持文件，用于数据质量控制和审核。重点关注火炬燃烧、各生产装置（催化裂化、
        催化重整、乙烯裂解、制氢、焦化等）运行、化石燃料燃烧以及CO2/CH4回收利用等环节的相关记录。
      </Paragraph>
...
export default PetroleumCarbonInventory;