  ...
  return (
    <div className="aero-industry">
      <Card title="中国石油化工企业温室气体排放核算" style={{ marginBottom: '20px' }}>
        ...
        <Paragraph>
          核算范围包括：企业级化石燃料燃烧排放、企业级火炬燃烧排放、工业生产过程CO2排放（包括催化裂化装置催化剂烧焦排放、催化重整装置催化剂烧焦排放、其它装置催化剂烧焦排放、制氢装置排放、焦化装置排放、石油焦煅烧装置排放、氧化沥青装置排放、乙烯裂解装置排放、乙二醇/环氧乙烷生产装置排放）、购入净电（化石）和净热隐含的CO2排放，以及扣除企业CO2回收利用量、企业CH4回收利用量。
        </Paragraph>
      </Card>
