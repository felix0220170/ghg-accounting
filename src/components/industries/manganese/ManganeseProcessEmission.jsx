...
const DEFAULT_CH4_ESCAPE_PRODUCTS = [
  { id: 'process-emission-1', name: '硅铁生产', emissionFactor: 2.79},
];
      ...
      <div style={{ marginTop: '20px',marginBottom: '40px' }}>
        <div style={{ marginBottom: '20px' }}>
          <div style={{ marginBottom: '16px', lineHeight: '1.6' }}>
            <p>镁冶炼企业所涉及的能源作为原材料用途的排放主要是厂界内的自有硅铁生产工序消耗蓝炭还原剂所导致的二氧化碳排放，蓝炭是一种能源产品。</p>
            <p>如果企业从事镁冶炼生产所用的硅铁全部是外购的，则不涉及此类排放问题。若有其他能源作为原材料，可通过添加自定义材料的方式计入排放。</p>
          </div>
          <h3 style={{ marginBottom: '16px' }}>计算说明</h3>
          <div style={{ backgroundColor: '#f5f5f5', padding: '16px', borderRadius: '4px', lineHeight: '1.2' }}>
            <p>计算方法：排放量（tCO₂） = 材料产量 × 材料生产消耗能源的二氧化碳排放因子</p>
            <p>（默认示例：硅铁产量 × 硅铁生产消耗蓝炭的二氧化碳排放因子 tCO2／t-FeSi）</p>
            <p>- 产量单位为 t，保留两位小数</p>
            <p>- 排放因子单位为 tCO2／t-材料，保留四位小数</p>
            <p>（默认示例：排放因子单位为 tCO2／t-FeSi）</p>
