...
function ManganeseCarbonInventory() {
  // 镁冶炼行业碳排查材料清单数据
  const inventoryItems = [
    ...
    { key: '3', name: '组织机构图' },
    { key: '4', name: '厂区平面图' },
    { key: '5', name: '镁冶炼主要生产工艺流程图' },
    { key: '6', name: '备案的数据质量控制计划' },
    { key: '7', name: '化石燃料（煤、油、气等）消耗量原始记录' },
    { key: '8', name: '原材料（白云石、硅铁、蓝炭等）消耗记录和台账' },
    { key: '9', name: '月度原材料盘点表' },
    { key: '10', name: '化石燃料、原材料等结算发票' },
    { key: '11', name: '燃料油/汽油/柴油消耗原始记录' },
    { key: '12', name: '《能源购进、消费与库存表》' },
    { key: '13', name: '镁冶炼主要生产装置运行记录' },
    { key: '14', name: '白云石预处理工序记录' },
    { key: '15', name: '白云石煅烧工序生产记录' },
    { key: '16', name: '硅热还原工序生产记录' },
    { key: '17', name: '镁精炼工序生产记录' },
    { key: '18', name: '入厂原材料成分分析报告（白云石、硅铁、蓝炭等）' },
    { key: '19', name: '产品质量检验报告（金属镁等）' },
    { key: '20', name: '化石燃料元素分析报告' },
    { key: '21', name: '白云石成分分析报告（特别是CaCO3、MgCO3含量）' },
    { key: '22', name: '白云石煅烧分解排放监测记录' },
    { key: '23', name: '硅铁生产消耗蓝炭的记录和台账' },
    { key: '24', name: '自有硅铁生产工序的运行记录' },
    { key: '25', name: '外购硅铁的采购合同和发票' },
    { key: '26', name: '流量计校验记录' },
    ...
    { key: '33', name: '废气排放监测报告' },
    { key: '34', name: '产品产量台账（金属镁等）' },
  ...
  return (
    <Card title="碳排查材料清单" style={{ marginBottom: '20px' }}>
      ...
      <Paragraph>
        本模块用于上传镁冶炼企业碳排查所需的材料清单文件。请按照要求上传相关证明材料和记录文档。
        所有材料为碳排查工作的必要支持文件，用于数据质量控制和审核。重点关注白云石煅烧、硅铁生产（如自有）
        和化石燃料燃烧等环节的相关记录。
      </Paragraph>
...
export default ManganeseCarbonInventory;