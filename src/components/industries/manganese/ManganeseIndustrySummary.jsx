...
const ManganeseIndustrySummary = ({ emissionData, industry, onDataChange }) => {
  // 确保data不为undefined
  ...
  const calculateBaseTotal = () => {
    return (
      ...
      calculateEmission('processEmission') + // 能源作为原材料用途的排放
  ...
  const tableData = [
    ...
    },
    {
      ...
      name: '工业生产过程中排放（主要是白云石煅烧分解所导致的二氧化碳排放）',
  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧CO2排放 + 能源作为原材料用途的排放 + 工业生产过程中排放（主要是白云石煅烧分解所导致的二氧化碳排放）</p>
        <p><strong>总排放量（含电力和热力）</strong> = 基础排放量（不含电力和热力） + 净购入电力和热力隐含的CO2排放</p>
        <p>注：能源作为原材料用途的排放以硅铁生产消耗蓝炭为默认材料，如硅铁全部外购则不涉及此类排放</p>
      </div>
