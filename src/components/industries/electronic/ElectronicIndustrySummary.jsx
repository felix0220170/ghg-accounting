...
const ElectronicIndustrySummary = ({ emissionData, industry, onDataChange }) => {
  // 确保data不为undefined
  ...
  const tableData = [
    ...
    },
    {
      ...
      name: '工业生产过程中排放（主要是半导体生产中刻蚀与CVD腔室清洗过程中由于化学反应或气体泄漏等造成的温室气体排放）',
  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧CO2排放 + 工业生产过程中排放</p>
...
export default ElectronicIndustrySummary;