  ...
  return (
    <div className="aluminum-industry">
      <Card title="铝冶炼行业温室气体排放核算" style={{ marginBottom: '20px' }}>
        ...
        <Paragraph>
          核算范围包括：化石燃料燃烧排放、铝冶炼工序排放、发电设施及其他非生产设施排放、净购入电力和热力隐含的排放等。
        </Paragraph>
      </Card>
      ...
      <Tabs defaultActiveKey="summary">
          ...
          <TabPane tab="电解铝工序能源作为原料用途排放（炭阳极）" key="carbonAnode">
          ...
          <TabPane tab="阳极效应排放" key="anode-effect">
          ...
          <TabPane tab="碳酸盐分解排放" key="carbonate-decomposition">
          ...
          <TabPane tab="购入净电（化石）和净热" key="net-electricity-heat">
