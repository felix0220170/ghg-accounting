...
function BuildingCarbonInventory() {
  ...
  const inventoryItems = [
    ...
    { 
      key: '4', 
      name: '电气设备与制冷设备资料', 
      description: 'HFCs、PFCs、SF6等温室气体使用记录、设备清单、气体采购凭证、泄漏检测报告、维护记录、回收处置证明', 
      required: true,
      category: '电气设备与制冷设备排放'
    },
    { 
      key: '5', 
      name: '电焊保护气相关资料', 
      description: 'CO2气体保护焊使用记录、气体采购凭证、气瓶标识、气体成分分析报告、库存台账、气体用量统计', 
      required: true,
      category: '电焊保护焊CO2排放'
    },
    { 
  ...
  return (
    <Card title="机械设备制造业碳核查资料清单" style={{ marginBottom: '20px' }}>
      <Title level={5}>资料清单说明</Title>
      <Paragraph>
        本模块用于上传机械设备制造业碳核查所需的资料清单文件。机械设备制造业包括金属制品业、通用设备制造业、专用设备制造业、汽车制造业、铁路、船舶、航空航天及其他运输设备制造业、电气机械和器材制造业。
      </Paragraph>
      <Paragraph>
        <strong>核算范围：</strong>
      </Paragraph>
      <ul style={{ marginLeft: '20px', marginBottom: '15px' }}>
        <li>化石燃料燃烧排放</li>
        <li>电气设备与制冷设备生产过程中温室气体的排放</li>
        <li>二氧化碳气体保护焊产生的CO₂排放</li>
        <li>净购入电力和热力隐含的CO₂排放</li>
      </ul>
      <Paragraph>
        请按照要求上传相关证明材料和记录文档。所有资料为碳核查工作的必要支持文件，用于数据质量控制和审核。重点关注化石燃料使用、温室气体使用管理、电焊保护气使用以及购入能源等相关记录，确保碳排放核算的准确性和完整性。
      </Paragraph>
      <Paragraph style={{ fontSize: '12px', color: '#666', marginTop: '10px', padding: '8px', backgroundColor: '#f5f5f5', borderLeft: '3px solid #1890ff' }}>
        <strong>重要说明：</strong>根据机械设备制造业核算指南，请确保所有排放源数据的完整性和准确性，特别是电气设备中使用的HFCs、PFCs、SF6等温室气体以及电焊保护气中CO2的排放计算。所有计量设备应定期检定，数据记录应规范完整。
      </Paragraph>
