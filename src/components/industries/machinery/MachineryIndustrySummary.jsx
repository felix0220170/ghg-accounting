...
const BuildingIndustrySummary = ({ emissionData, industry, onDataChange }) => {
  // 确保data不为undefined
  ...
  const calculateBaseTotal = () => {
    return (
      ...
      calculateEmission('HFCsPFCsSF6Emission') +  // 电气设备与制冷设备生产过程中温室气体的排放
      calculateEmission('weldingCO2Emission')  // 二氧化碳气体保护焊产生的CO₂排放
    );
  };
  ...
  const tableData = [
    ...
    {
      key: 'HFCsPFCsSF6',
      name: '电气设备与制冷设备生产过程中温室气体的排放',
      value: safeData.HFCsPFCsSF6Emission || 0,
      co2e: calculateCO2e('HFCsPFCsSF6Emission', safeData.HFCsPFCsSF6Emission || 0)
    },
    {
      key: 'welding-CO2',
      name: '二氧化碳气体保护焊产生的CO₂排放',
      value: safeData.weldingCO2Emission || 0,
      co2e: calculateCO2e('weldingCO2Emission', safeData.weldingCO2Emission || 0)
    },
    {
  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧排放 + 电气设备与制冷设备生产过程中温室气体的排放 + 二氧化碳气体保护焊产生的CO₂排放</p>
...
export default BuildingIndustrySummary; 
