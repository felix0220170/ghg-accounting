...
const FoodIndustrySummary = ({ emissionData, industry, onDataChange }) => {
  // 确保data不为undefined
  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>工业生产过程中排放</strong>：过程排放量是企业消耗的各种碳酸盐发生分解反应以及外购工业生产的二氧化碳作为原料在使用过程中损耗导致的排放量之和。</p>
      </div>
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        <Title level={5}>计算公式</Title>
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧排放 + 工业生产过程中排放 + 废水厌氧处理排放</p>
