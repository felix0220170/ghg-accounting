...
function FoodCarbonInventory() {
  // 食品、烟草及酒、饮料和精制茶企业碳核查资料清单数据
  ...
  return (
    <Card title="食品、烟草及酒、饮料和精制茶企业碳核查资料清单" style={{ marginBottom: '20px' }}>
      <Title level={5}>资料清单说明</Title>
      <Paragraph>
        本模块用于上传食品、烟草及酒、饮料和精制茶企业碳核查所需的资料清单文件。涵盖了食品加工、烟草制造、酒类生产、饮料制造和精制茶加工等生产活动。
      </Paragraph>
      <Paragraph>
        <strong>核算范围：</strong>
      </Paragraph>
      ...
      <Paragraph>
        请按照要求上传相关证明材料和记录文档。所有资料为碳核查工作的必要支持文件，用于数据质量控制和审核。重点关注化石燃料使用、工业生产过程、废水厌氧处理以及购入能源等相关记录，确保碳排放核算的准确性和完整性。
      </Paragraph>
      <Paragraph style={{ fontSize: '12px', color: '#666', marginTop: '10px', padding: '8px', backgroundColor: '#f5f5f5', borderLeft: '3px solid #1890ff' }}>
        <strong>重要说明：</strong>根据食品、烟草及酒、饮料和精制茶企业核算指南，请确保所有排放源数据的完整性和准确性，特别是废水厌氧处理排放的计算。所有计量设备应定期检定，数据记录应规范完整。
      </Paragraph>
...
export default FoodCarbonInventory;
