  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧CO2排放 + 火炬燃烧排放 + 油气勘探业务温室气体排放 + 油气开采业务温室气体排放 + 油气处理业务温室气体排放 + 油气储运业务温室气体排放</p>
        <p><strong>总排放量（含电力和热力）</strong> = 基础排放量（不含电力和热力） + 购入净电（化石）和净热隐含的CO2排放 - <span style={{ color: '#1890ff', fontWeight: 'bold' }}>企业CO2回收利用量</span> - <span style={{ color: '#1890ff', fontWeight: 'bold' }}>企业CH4回收利用量</span></p>
