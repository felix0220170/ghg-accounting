...
function MineCarbonInventory() {
  // 矿山企业碳核查资料清单数据
  const inventoryItems = [
    { 
      key: '1', 
      name: '企业基本信息', 
      description: '营业执照、组织机构代码证、生产许可证、采矿许可证、企业产权证明、矿区平面图、采矿工艺流程图', 
      required: true,
      category: '基本信息'
    },
    { 
    ...
    { 
      key: '3', 
      name: '碳酸盐分解排放相关资料', 
      description: '碳酸盐种类、消耗量、纯度、排放因子、生产记录、质量检验报告', 
      required: true,
      category: '碳酸盐分解排放'
    },
    { 
      key: '4', 
      name: '碳化工艺吸收的CO₂量相关资料', 
      description: '碳化产物质量、排放因子、成分分析报告、生产记录、质量检验报告', 
      required: true,
      category: '碳化工艺吸收CO₂'
    },
    { 
    ...
    { 
      key: '6', 
      name: '生产运营记录', 
      description: '采矿生产台账、选矿生产台账、产量统计、设备运行记录、班次记录、工艺参数记录、质量检验记录', 
      required: true,
      category: '运营数据'
    },
    { 
  ...
  return (
    <Card title="矿山企业碳核查资料清单" style={{ marginBottom: '20px' }}>
      <Title level={5}>资料清单说明</Title>
      <Paragraph>
        本模块用于上传矿山企业碳核查所需的资料清单文件。矿山企业涵盖了煤矿、金属矿、非金属矿等各类矿山的开采、选矿、加工等生产活动。
      </Paragraph>
      <Paragraph>
        <strong>核算范围：</strong>
      </Paragraph>
      ...
      <Paragraph>
        请按照要求上传相关证明材料和记录文档。所有资料为碳核查工作的必要支持文件，用于数据质量控制和审核。重点关注化石燃料使用、碳酸盐分解、碳化工艺吸收以及购入能源等相关记录，确保碳排放核算的准确性和完整性。
      </Paragraph>
      <Paragraph style={{ fontSize: '12px', color: '#666', marginTop: '10px', padding: '8px', backgroundColor: '#f5f5f5', borderLeft: '3px solid #1890ff' }}>
        <strong>重要说明：</strong>根据矿山企业核算指南，请确保所有排放源数据的完整性和准确性，特别是碳酸盐分解排放和碳化工艺吸收的CO₂量的计算。所有计量设备应定期检定，数据记录应规范完整。
      </Paragraph>
...
export default MineCarbonInventory;