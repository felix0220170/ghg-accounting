...
function CeramicsCarbonInventory() {
  // 陶瓷生产行业碳核查资料清单数据
  const inventoryItems = [
    { key: '1', name: '陶瓷生产企业基本信息', description: '企业营业执照、生产许可证、工艺流程图等基础资料', required: true },
    { key: '2', name: '能源消耗台账', description: '各类化石燃料（如煤、天然气、重油等）的采购、储存和消耗记录', required: true },
    { key: '3', name: '陶瓷原料采购与消耗记录', description: '陶瓷原料（如黏土、长石、碳酸盐等）的采购数量、成分分析报告（主要是碳酸盐含量）', required: true },
    { key: '4', name: '电力和热力采购记录', description: '电网公司开具的电费发票、热力供应合同及发票', required: true },
    { key: '5', name: '生产报表', description: '陶瓷产品产量报表、生产日志等', required: true },
    { key: '6', name: '排放监测报告', description: '如果有在线监测设备，需提供连续监测数据报告', required: false }
  ];
  ...
  return (
    <Card title="陶瓷生产行业碳核查资料清单" style={{ marginBottom: '20px' }}>
      <Title level={5}>资料清单说明</Title>
      <Paragraph>
        本模块用于上传陶瓷生产企业碳核查所需的资料清单文件。请按照要求上传相关证明材料和记录文档。
        所有资料为碳核查工作的必要支持文件，用于数据质量控制和审核。重点关注能源消耗、原料使用和生产工艺等环节的相关记录。
      </Paragraph>
...
export default CeramicsCarbonInventory;