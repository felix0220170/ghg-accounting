...
const DEFAULT_CARBONATE_PRODUCTS = [
  { id: 'process-1', name: '硝酸氧化工艺', emissionFactor: 0.3000 },
  { id: 'process-2', name: '其它工艺', emissionFactor: 0 }
];
...
function ChemicalAdipicAcidEmission({ onEmissionChange }) {
  // 碳酸盐列表状态
  ...
  const renderTotalEmissionTable = () => {
    ...
    return (
      <table style={{ borderCollapse: 'collapse', width: '100%', marginTop: '24px', backgroundColor: '#f9f9f9' }}>
        ...
        <tbody>
          <tr>
            <td style={{ border: '1px solid #d9d9d9', padding: '8px', fontWeight: 'bold' }}>己二酸生产过程的排放总量</td>
  ...
  return (
    <div style={{ padding: '16px' }}>
      <h2 style={{ marginBottom: '24px', fontSize: '20px', color: '#333' }}>己二酸生产过程排放</h2>
      {/* 碳酸盐 */}
      <div style={{ marginTop: '20px',marginBottom: '40px' }}>
        ...
        <div style={{ marginTop: '24px', backgroundColor: '#fff', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.1)', marginBottom: '24px' }}> 
            <h3 style={{ marginBottom: '20px', color: '#1890ff', fontWeight: 'bold', fontSize: '18px' }}>添加己二酸生产排放记录</h3>
...
export default ChemicalAdipicAcidEmission;