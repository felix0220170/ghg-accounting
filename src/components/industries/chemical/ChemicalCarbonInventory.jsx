...
function ChemicalCarbonInventory() {
  // 化工行业碳排查材料清单数据
  const inventoryItems = [
    ...
    { key: '8', name: '原材料（碳酸盐、硝酸、己二酸等）消耗记录和台账' },
    { key: '9', name: '月度原材料盘点表' },
    { key: '10', name: '化石燃料、原材料等结算发票' },
    { key: '11', name: '燃料油/汽油/柴油消耗原始记录' },
    { key: '12', name: '《能源购进、消费与库存表》' },
    { key: '13', name: '主要生产装置运行记录' },
    { key: '14', name: '原材料预处理工序记录' },
    { key: '15', name: '化学反应工序生产记录' },
    { key: '16', name: '产品分离提纯工序记录' },
    { key: '17', name: '入厂原材料成分分析报告' },
    { key: '18', name: '产品质量检验报告' },
    { key: '19', name: '化石燃料元素分析报告' },
    { key: '20', name: '碳酸盐分解排放监测记录' },
    { key: '21', name: '硝酸生产N2O排放监测记录' },
    { key: '22', name: '己二酸生产N2O排放监测记录' },
    { key: '23', name: '流量计校验记录' },
    { key: '24', name: '电子地磅检定证书' },
    { key: '25', name: '分析仪器校准记录' },
    { key: '26', name: '电力消耗抄表记录' },
    { key: '27', name: '热力消耗结算单' },
    { key: '28', name: '电力热力结算发票' },
    { key: '29', name: '电表/热量表检定证书' },
    { key: '30', name: 'CO2回收利用量记录' },
  ...
  return (
    <Card title="碳排查材料清单" style={{ marginBottom: '20px' }}>
      ...
      <Paragraph>
        本模块用于上传化工行业碳排查所需的材料清单文件。请按照要求上传相关证明材料和记录文档。
...
export default ChemicalCarbonInventory;