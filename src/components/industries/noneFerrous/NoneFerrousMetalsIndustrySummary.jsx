...
const ManganeseIndustrySummary = ({ emissionData }) => {
  // 确保data不为undefined
  ...
  const calculateBaseTotal = () => {
    return (
      ...
      calculateEmission('energyEmission') + // 能源作为原材料用途的排放
      calculateEmission('processEmission') // 工业生产过程中碳酸盐分解排放
    );
  };
  ...
  const tableData = [
    ...
    },
    {
      ...
      name: '能源作为原材料用途的排放',
      value: safeData.energyEmission || 0,
      co2e: calculateCO2e('energyEmission', safeData.energyEmission || 0),
      highlight: false // 突出显示硅铁蓝炭默认材料
    },
    {
      key: 'carbonate-decomposition',
      name: '工业生产过程中排放（各种碳酸盐以及草酸发生分解反应导致的排放）',
  ...
  return (
    <div className="summary-table-container">
      <div className="formula-section" style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <p><strong>基础排放量（不含电力和热力）</strong> = 化石燃料燃烧CO2排放 + 能源作为原材料用途的排放 + 工业生产过程中排放（主要是各种碳酸盐以及草酸发生分解反应所导致的二氧化碳排放）</p>
...
export default ManganeseIndustrySummary;
